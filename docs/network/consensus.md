...
Raft是Paxos的一种实现或变种，是由Stanford提出的一种更易理解的一致性算法，意在取代广为使用的Paxos算法。目前，在各种主流语言中都有了一些开源实现，比如本文中将使用的基于JGroups的Raft协议实现。
...
　　![img](762938-20180608220810083-449797518.png)
...
- **追踪节点（tracking node）：**主要功能是分发交易信息以及响应客户端的账本请求。
